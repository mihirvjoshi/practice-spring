...
import com.practice.spring.config.AppConfig;
import com.practice.spring.thread.PrintTask2;

public class AppWithConfigBeanTest {
    
	public static void main(String[] args) {
		ApplicationContext context = new AnnotationConfigApplicationContext(AppConfig.class);

		ThreadPoolTaskExecutor taskExecutor = (ThreadPoolTaskExecutor) context.getBean("taskExecutors");
